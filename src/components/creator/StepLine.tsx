  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        {data.line ? (
          <div className="md-card md-elevation-1 p-4 flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-[var(--md-sys-color-primary-container)] flex items-center justify-center">
              <DirectionsBusIcon sx={{ fontSize: 24, color: 'var(--md-sys-color-on-primary-container)' }} />
            </div>
            ...
            {loadingLines ? (
              ...
              <div className="space-y-2 max-h-48 overflow-y-auto">
                {lines.map((line) => (
                  ...
                  >
                    <DirectionsBusIcon sx={{ fontSize: 20, color: 'var(--md-sys-color-primary)' }} />
                    <div>
        ...
        {data.line && (
          <button onClick={handleClearLine} className="mt-3 md-text-button text-[var(--md-sys-color-error)]">
            Zmień linię
          </button>
        )}
      </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="md-body-medium truncate">
                    {stop.city}{stop.name && `, ${stop.name}`}
                  </p>
                  {stop.isNew && (
                    <span className="text-xs text-[var(--md-sys-color-tertiary)]">Nowy przystanek</span>
                  )}
                </div>
