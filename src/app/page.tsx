	...
	return (
		<PageWrapper>
			...
			<div className="text-center mb-16 pt-12">
				<div className="inline-flex items-center justify-center w-24 h-24 mb-6 rounded-full bg-(--md-sys-color-primary-container)">
					<DirectionsBusIcon
						sx={{ fontSize: 48, color: "var(--md-sys-color-on-primary-container)]" }}
					/>
				</div>

				<h1 className="md-headline-large text-(--md-sys-color-on-background) mb-4">
					Mój Wsiobus
				</h1>

				<p className="md-body-large text-(--md-sys-color-on-surface-variant) max-w-2xl mx-auto mb-8">
				...
				<div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
					...
					<Link href="/app" className="md-outlined-button inline-flex items-center gap-2">
						<WebIcon />
			...
			<div className="md-card md-elevation-3 max-w-3xl mx-auto mb-8">
				<div className="p-8">
					...
					<p className="md-body-large text-(--md-sys-color-on-surface-variant) text-center">
			...
			<div className="max-w-4xl mx-auto mb-8">
				<div className="grid grid-cols-2 md:grid-cols-2 gap-6">
					<div className="md-card md-elevation-1 text-center">
						<div className="inline-flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-(--md-sys-color-primary-container)">
							<FlashOnIcon
								sx={{
									fontSize: 32,
						...
						<p className="md-body-medium text-(--md-sys-color-on-surface-variant)">
							Pobierz rozkład raz - działa bez internetu.
							<br />
					...
					<div className="md-card md-elevation-1 text-center">
						<div className="inline-flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-(--md-sys-color-secondary-container)">
							<CloudOffIcon
								sx={{
									fontSize: 32,
					...
					<div className="md-card md-elevation-1 text-center">
						<div className="inline-flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-(--md-sys-color-tertiary-container)">
							<SortIcon
								sx={{
									fontSize: 32,
			...
			<footer className="mt-16 text-center">
				<div className="flex justify-center gap-6 mb-4">
					<Link
						href="/contact"
						className="md-body-medium text-(--md-sys-color-primary) hover:underline"
					>
						Kontakt
					</Link>
